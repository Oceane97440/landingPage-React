            ...
            <div id="row">
                ...
                <img className="ver" src={process.env.PUBLIC_URL + "bar.svg"}/>
                    ...
                    <ul className="element-card">
                        ...
                        <li  className="item-card"><h4>Interfaces créative</h4></li>
                ...
                <img className="ver" src={process.env.PUBLIC_URL + "bar.svg"}/>
                    ...
                    <ul className="element-card">
                        ...
                        <li  className="item-card"><h4>Campagne digital</h4></li>
                ...
                <img className="ver" src={process.env.PUBLIC_URL + "bar.svg"}/>
                    ...
                    <ul className="element-card">
                        ...
                        <li  className="item-card"><h4>Audiovisuels</h4></li>
                ...
                <img className="ver" src={process.env.PUBLIC_URL + "bar.svg"}/>
                    ...
                    <ul className="element-card">
                        ...
                        <li  className="item-card"><h4>Développement mobiles</h4></li>
